...
((SELECT id FROM pedido WHERE numero = 'PED-2024-001'), 'Cinta aislante negra 20m', 10, 'ud', 5.00, 50.00),
((SELECT id FROM pedido WHERE numero = 'PED-2024-001'), 'Pack Destornilladores (6 uds)', 4, 'ud', 25.00, 100.00),
((SELECT id FROM pedido WHERE numero = 'PED-2024-002'), 'Papel A4 80g (Caja 5 resmas)', 10, 'caja', 7.55, 75.50),
...
((SELECT id FROM factura WHERE numero_factura = 'FAC-2024-101'), (SELECT id FROM pedido WHERE numero = 'PED-2024-001'), 150.00),
((SELECT id FROM factura WHERE numero_factura = 'FAC-2024-202'), (SELECT id FROM pedido WHERE numero = 'PED-2024-002'), 75.50);
